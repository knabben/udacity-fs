...
from flask import Blueprint, render_template, session, request, make_response, flash
from models import User, db
from helpers import get_session_string, redirect_flash
...
@login.route('/generate_session')
def generate_session():
    session['state'] = get_session_string()
...
def gdisconnect():
    ...
    if result['status'] == '200':
        ...
        response.headers['Content-Type'] = 'application/json'
        return redirect_flash('Logout success.')
